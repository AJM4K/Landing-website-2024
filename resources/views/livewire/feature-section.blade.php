<section class=" bg-white ">
    <div class="w-full h-auto flex-col   justify-center items-center py-8 px-4 mx-auto max-w-screen-xl  text-center lg:py-16 lg:px-12">
    <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl



">
        @lang('messages.features_title')
    </h1>
...
">
        @lang('messages.features_description')    </p>
