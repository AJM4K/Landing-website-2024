<div>
    <div>
        ...
        {{--            <div>--}}
        {{--                <div class="flex justify-center items-center mb-4 container mx-auto h-1920 w-1080 rounded-3xl  bg-primary-100  dark:bg-primary-900">--}}
        ...
        {{--                    <img class="aspect-[16/9] rounded-3xl  object-cover w-full



" src="http://localhost:8002/images/image4.jpg" alt="dashboard image">--}}
...
">--}}
        {{--                    @lang('messages.services_description4')--}}
        {{--                </p>--}}
        {{--                <a href="{{ Route('about') }}" class="my-3 inline-flex items-center rounded-3xl text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium text-sm px-5 py-2.5 text-center
...
" src="http://localhost:8002/images/image5.jpg" alt="dashboard image">--}}
...
">--}}
        {{--                    @lang('messages.services_description5')--}}
        {{--                </p>--}}
        {{--                <a href="{{ Route('about') }}" class="my-3 inline-flex items-center rounded-3xl text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium text-sm px-5 py-2.5 text-center
...
" src="http://localhost:8002/images/image6.jpg" alt="dashboard image">--}}
...
">--}}
        {{--                    @lang('messages.services_description6')--}}
        {{--                </p>--}}
        {{--                <a href="{{ Route('about') }}" class="my-3 inline-flex items-center rounded-3xl text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium text-sm px-5 py-2.5 text-center
